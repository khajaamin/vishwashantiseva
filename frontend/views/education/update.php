    ...
    <div class="col_4">
        <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
           <ul id="myTab" class="nav nav-tabs nav-tabs1" role="tablist">
              <li role="presentation" ><a href="<?php echo Url::toRoute('profile/update')?>" id="home-tab" role="tab" ><?php echo \Yii::t('app', 'Basic Info');?></a>
              <!-- <a href="<?php //echo Url::toRoute('profile/update');?>" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><?php //echo \Yii::t('app', 'Basic Info');?></a> --></li>
